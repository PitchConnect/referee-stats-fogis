...
from referee_stats_fogis.config import config as app_config
...
db_type = app_config.get("database.type", "sqlite")
if db_type == "sqlite":
    db_path = app_config.get("database.path", "data/referee_stats.db")
    ...
    database = app_config.get("database.name", "referee_stats")
